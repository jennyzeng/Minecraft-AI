...
NUM_CHANNELS = 3
BATCH_SIZE = 10
proj_path = "set manually here"

###model for  classsification
pig_file = str(proj_path) + "/sklearn_model/weather.pkl"
...
pig_checkpoint_file = str(proj_path) + "/model/pig_model2/pig_model.ckpt"
...
my_mission, my_mission_record = init_mission(target_biome_label, 'normal', '6000', 'pig')
